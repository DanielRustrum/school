...
public class IteratorClassLL
{
    ...
    /**
     * recursive helper method that creates string from data with cursor indicator at appropriate location and no space at end of string 
     * 
     * @param workingRef
     * @return string value concatenated with previous recursions
     */
    private String toStringHelper(NodeClass workingRef)
    {
        @SuppressWarnings("unused")
        String combinedString = "";
        if(cursorRef.nextNode != null && headRef != null)
        {
    ...
    /**
     * Stores The Data For The Iterator Class
     * 
     * @author daniel_rustrum
     *
     */ 
    private class NodeClass
    {
        ...
        public int value;
        /**
         * Stores the reference to the next object
         */
        public NodeClass nextNode = null;
        /**
         * Saves the value passed through the constructor
         * 
         * @param inVal
         */
        NodeClass(int inVal)
